SKYLINE_VCS_STATUS_PREFIX="${SKYLINE_VCS_STATUS_PREFIX=\ue0b3}"
SKYLINE_VCS_STATUS_SUFFIX="${SKYLINE_VCS_STATUS_SUFFIX=\ue0b1}"
...
skyline::git_status_icons() {
  skyline::section green $SKYLINE_GIT_STATUS_UNTRACKED $SKYLINE_VCS_STATUS_PREFIX $SKYLINE_VCS_STATUS_SUFFIX
}